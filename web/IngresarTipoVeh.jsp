<%-- 
    Document   : IngresarTipoVeh
    Created on : 26/05/2022, 10:55:10 PM
    Author     : MSarazua
--%>
...
<html>
    <head>
        ...
        <title>Ingresar Tipo de vehículo</title>
    </head>
        ...
        <div id="layoutSidenav_content">
            <main >
                <div class="container-fluid px-4 row">
                    ...
                    <div class="col-md-10 ">
                        <br>
                        <h1 class="mt-5">Crear Tipo de vehículo</h1>
                        <form class="container col-10 col-md-10 col-lg-10" class="row g-3" action="TipoVehController" method="get">
                            ...
                            <button type="submit" name="accion" value="create" class="btn btn-primary mb-2" >Agregar Tipo</button>
                      </form>
                    </div>
                </div>
            </main>
