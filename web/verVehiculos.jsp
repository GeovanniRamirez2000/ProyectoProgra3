                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                             ...
                             <td class="text-center">
                                 <a href="ControllerVehiculo?accion=editar&id=<%=mostrarVehiculos.getId_vehiculo()%>">Editar</a>
                                 <a href="ControllerVehiculo?accion=eliminar&id=<%=mostrarVehiculos.getId_vehiculo()%>">Eliminar</a>
                              </td>
