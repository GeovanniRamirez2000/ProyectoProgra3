                    ...
                    <tbody>
                        <tr>
                            <td class="text-center">
                                <input type="text" name="id" value="<%= mostrarpermiso.getId_permiso() %>">
                            </td>
                            <td class="text-center">
                                <select name="modulo">
                            ...
                            <td class="text-center">
                                ...
                                <option value="<%= mostrarpermiso.getId_permiso() %>"><%= mostrarpermiso.getId_rol() %></option>
                            ...
                            <td class="text-center">
                             ...
                             <td class="text-center">
                                 <input type="submit" name="accion" value="editar" class="btn btn-primary mb-2">
